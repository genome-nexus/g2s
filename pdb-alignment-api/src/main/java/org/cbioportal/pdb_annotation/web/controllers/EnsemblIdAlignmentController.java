...
public class EnsemblIdAlignmentController {
    ...
    public List<Residue> getPdbResidueByEnsemblId (
            ...
            @ApiParam(value = "Input Ensembl Id e.g. ENSP00000489609.1", required = true, allowMultiple = true) String ensemblId, 
            @RequestParam(required = true)
            @ApiParam(value = "Input Residue Position e.g. 300", required = true, allowMultiple = true) String aaPosition) {

...
public class PdbScriptsPipelineStarter {
    ...
    public static void main(String[] args) {
        ...
        case WEEKLY_UPDATE_COMMAND:
            // user could deploy and change the settings in
            // application.properties
            // the program run continuously, scheduling updates on a weekly
            // basis
            ...
            // PDB is updated at Tuesday, 5 pm PDT during daylight saving time
            // in the US, and 4 pm PST otherwise
        ...
        case IMMEDIATE_UPDATE_COMMAND:
            // update immediately then exit; users should use CRON or other
            // scheduling mechanisms to run the updates
        ...
        log.info("[Pipeline] Pipeline Successfully Ended. The Execution time is "

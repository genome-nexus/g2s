...
public class Quote {
     ...
     * 
     * private String allele_string; private String assembly_name; private
     * List<Colocated_variants> colocated_variants; private long end; private
    ...
    /*
     * public String getAllele_string() { return allele_string; }
     * 
     * public void setAllele_string(String allele_string) { this.allele_string =
     * allele_string; }
     * 
     * public String getAssembly_name() { return assembly_name; }
     * 
     * public void setAssembly_name(String assembly_name) { this.assembly_name =
     * assembly_name; }
     * 
     * public List<Colocated_variants> getColocated_variants() { return
     * colocated_variants; }
     * 
     * public void setColocated_variants(List<Colocated_variants>
     * colocated_variants) { this.colocated_variants = colocated_variants; }
     * 
     ...
     * 
     * public String getMost_severe_consequence() { return
     ...
     * 
     * public String getSeq_region_name() { return seq_region_name; }
     * 
     ...
     * allele_string + ", assembly_name=" + assembly_name +
     * ", colocated_variants=" + colocated_variants + ", end=" + end + ", id=" +
     * id + ", input=" + input + ", most_severe_consequence=" +
     * most_severe_consequence + ", seq_region_name=" + seq_region_name +
